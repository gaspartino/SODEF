...
for loop_idx in range(args.total_loops):
    ...
    folder = f'./EXP/resnetfct5_15/model{loop_idx+1}.pth'
    ...
    def bstl_loaders(train_batch_size=256, test_batch_size=512, normalize=False):
        ...
        train_eval_loader = DataLoader(train_data, batch_size=train_batch_size, shuffle=False)
    ...
    saved_temp = torch.load(folder_savemodel+f'/ckpt{loop_idx+1}.pth')
    ...
    test_loader_samples = DataLoader(test_samples, batch_size=100, shuffle=False, drop_last=False)
