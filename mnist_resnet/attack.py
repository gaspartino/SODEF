...
for loop_idx in range(args.total_loops):
    ...
    saved = torch.load(folder_dense, weights_only=False)
    ...
    class fcs(nn.Module):
        ...
        def __init__(self,  in_features=512):
            ...
            self.merge_net = nn.Sequential(nn.Linear(in_features=in_features,
                                                 out_features=2048), nn.Tanh(), nn.Linear(in_features=2048, out_features=fc_dim), nn.Tanh(), )
    ...
    saved_temp = torch.load(folder_extractor)
